...
describe('Service Tests', () => {
  describe('ProductOrder routing resolve service', () => {
    ...
    describe('resolve', () => {
      it('should return existing IProductOrder for existing id', () => {
        // GIVEN
        service.find = jest.fn(id => of(new HttpResponse({ body: new ProductOrder(id) })));
        ...
        expect(resultProductOrder).toEqual(new ProductOrder(123));
      });
