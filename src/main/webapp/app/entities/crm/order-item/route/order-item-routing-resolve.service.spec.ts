...
describe('Service Tests', () => {
  describe('OrderItem routing resolve service', () => {
    ...
    describe('resolve', () => {
      it('should return existing IOrderItem for existing id', () => {
        // GIVEN
        service.find = jest.fn(id => of(new HttpResponse({ body: new OrderItem(id) })));
        ...
        expect(resultOrderItem).toEqual(new OrderItem(123));
      });
