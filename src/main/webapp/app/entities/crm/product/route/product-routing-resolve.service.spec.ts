...
describe('Service Tests', () => {
  describe('Product routing resolve service', () => {
    ...
    describe('resolve', () => {
      it('should return existing IProduct for existing id', () => {
        // GIVEN
        service.find = jest.fn(id => of(new HttpResponse({ body: new Product(id) })));
        ...
        expect(resultProduct).toEqual(new Product(123));
      });
