...
describe('Service Tests', () => {
  describe('Customer routing resolve service', () => {
    ...
    describe('resolve', () => {
      it('should return existing ICustomer for existing id', () => {
        // GIVEN
        service.find = jest.fn(id => of(new HttpResponse({ body: new Customer(id) })));
        ...
        expect(resultCustomer).toEqual(new Customer(123));
      });
