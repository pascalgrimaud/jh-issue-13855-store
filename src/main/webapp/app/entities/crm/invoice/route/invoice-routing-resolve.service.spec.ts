...
describe('Service Tests', () => {
  describe('Invoice routing resolve service', () => {
    ...
    describe('resolve', () => {
      it('should return existing IInvoice for existing id', () => {
        // GIVEN
        service.find = jest.fn(id => of(new HttpResponse({ body: new Invoice(id) })));
        ...
        expect(resultInvoice).toEqual(new Invoice(123));
      });
