...
describe('Shipment e2e test', () => {
  ...
  it('should create an instance of Shipment', () => {
    ...
    cy.get(`[data-cy="trackingCode"]`).type('Mouse Villages', { force: true }).invoke('val').should('match', new RegExp('Mouse Villages'));


    cy.get(`[data-cy="date"]`).type('2021-02-12T21:49').invoke('val').should('equal', '2021-02-12T21:49');


    cy.get(`[data-cy="details"]`).type('unleash integrate', { force: true }).invoke('val').should('match', new RegExp('unleash integrate'));
